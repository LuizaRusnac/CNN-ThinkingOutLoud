...
domain = 'frequency'
band_samples = 0
detailes = "No mean extraction with feature standardization"

names = ['xtrain_%ds_50tr-50tst_cov-%s_B%d_mean_kfold.npy'%(window, domain, band_samples),
    'ytrain_%ds_50tr-50tst_cov-%s_B%d_mean_kfold.npy'%(window, domain, band_samples),
	'xval_%ds_50tr-50tst_cov-%s_B%d_mean_kfold.npy'%(window, domain, band_samples),
	'yval_%ds_50tr-50tst_cov-%s_B%d_mean_kfold.npy'%(window, domain, band_samples),
    'xtest_%ds_50tr-50tst_cov-%s_B%d_mean_kfold.npy'%(window, domain, band_samples),
    'ytest_%ds_50tr-50tst_cov-%s_B%d_mean_kfold.npy'%(window, domain, band_samples)]
...
model_config = {'in_shape': (xtrain.shape[2], xtrain.shape[3], 1), 'n_classes': 11,
'nr_layers_Conv2D': 2, 'filters': [64, 128], 'dropout_Conv2D': 0, 'activation_fncs': ['relu'], 
...
'dense_act_fnc', 'll_activation_function', 'optimizer', 'learning_rate', 'loss',
